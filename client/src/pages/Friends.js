...
const CompareUser = () => {
  ...
  //   if (similarity) {
  //     if (Math.round(progress) !== similarity) {
  //       console.log(progress, similarity);

  //       setInterval(() => {
  //         setTimeout(() => {
  //           setProgress(
  //             similarity * Math.tanh((similarity / 100) * 0.02 * index)
  //           );
  //           console.log(progress, similarity);
  //           index++;
    ...
    await axios
      ...
      .catch((error) => {
        ...
        if (error.response.status === 400) {
          ...
          alert(
            "Something went wrong at this time :( Try someone else for now..."
          );
          setSearchInput("");
          setLoading(false);
        }
    ...
    await axios
      ...
      .then((response) => {
        ...
        if (
          ...
          response.data.username === "donald_trump"
        ) {
          response.data = {
              ...
              <div className="flex flex-col gap-2 sm:gap-5 w-3/4 max-w-5xl">
                <div className="flex justify-between gap-x-40">
                  <div className="flex flex-col gap-5 w-full relative">
                    ...
                    <div className="">
                      Want to find out how similar your anime taste is to other
                      users? Or do you want to find an anime club?
                    </div>
                    <div className="text-blue">Search by...</div>
                        ...
                        <div className="w-max">
                          <div className="bg-light-blue rounded-lg w-full">
                            <form className="p-2" onSubmit={handleSubmit}>
                              <input
                                type="text"
                                className="w-3/4 rounded-lg px-2"
                                value={searchInput}
                          ...
                          <div className="bg-lightgrey w-max rounded-lg align-middle">
                            <div className="flex flex-row">
                              <div className="ml-20 mr-0">
                                <Profile
                                  name={mostSimilarUser.username}
                                  image={
                                    mostSimilarUser.information.images.jpg
                                      .image_url !== null
                                      ? mostSimilarUser.information.images.jpg
                                          .image_url
                                      : paul1
                              ...
                              <div className="flex flex-col gap-5 px-5 pt-10 align-middle">
                                ...
                                <div>
                                  Reach out to your new friend on{" "}
                                  <a
                                    href={mostSimilarUser.information.url}
                                    className="text-blue hover:text-grey"
                                  >
                                    {" "}
                                    myanimelist.net
                                  </a>
