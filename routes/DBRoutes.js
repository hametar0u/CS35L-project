...
userRoute.route("/AddUserBySharedListId").post(async (req, res) => {
    ...
    try {
        ...
        let currentuser = {}
        url = `https://https://our-anime-list-beta.herokuapp.com//listings/retrieveUserByName`
        await axios
            .get(url, {
                params: {
                    name: username
        ...
        let information1 = {};
        await axios
        .post("https://https://our-anime-list-beta.herokuapp.com//listings/getUserById", {username: username})
        .then((response) => {
            if (response.data === {}) {
        ...
        //Reallocate genres
        await axios
            .post("https://https://our-anime-list-beta.herokuapp.com//listings/mainGenre", empty)
            .then((response) => {
...
userRoute.route("/getAllUsersOfList").post(async (req, res) => {
    ...
    try {
        ...
        //Grab shared list
        await axios
            .get("https://https://our-anime-list-beta.herokuapp.com//listings/sharedList")
            .then((response) => {
        ...
        let userlist = {};
        await axios
            .get("https://https://our-anime-list-beta.herokuapp.com//listings")
            .then((response) => {
...
userRoute.route("/listings/SpecificUser").post(async (req, res) => {
    ...
    try{
        ...
        let information = {};
                await axios
                .post("https://https://our-anime-list-beta.herokuapp.com//listings/getUserById", {username: req.body.name})
                .then((response) => {
                    if (response.data === {}) {
                        res.status(400).send("No user found in MongoDB!");
                        return;
...
userRoute.route("/listings/addUser").post(async (req, res) => {
    try {
        ...
        let current_user = {}
        let url = `https://https://our-anime-list-beta.herokuapp.com//listings/retreiveUserById`
        await axios
            .get(url, {
                params: {
                    id: userid
        ...
        if(!current_user.sharedlist_id)
        {
            ...
            if(append_user.sharedlist_id)
            {
                let information = {};
                await axios
                .post("https://https://our-anime-list-beta.herokuapp.com//listings/getUserById", {username: current_user.info.name})
                .then((response) => {
                    if (response.data === {}) {
                        res.status(400).send("No user found in MongoDB!");
                        return;
            ...
            else 
            {
                ...
                let information2 = {};
                await axios
                .post("https://https://our-anime-list-beta.herokuapp.com//listings/getUserById", {username: append_user.info.name})
                .then((response) => {
                    if (response.data === {}) {
                        res.status(400).send("No user found in MongoDB!");
                        return;
...
userRoute.route("/listings/animeDelete").post(async (req, res) => {
    try {
        ...
        let userlist = {}
        let url2 = `https://https://our-anime-list-beta.herokuapp.com//listings`
        await axios
            .get(url2)
            .then((response) => {
                userlist = response.data;
...
userRoute.route("/CheckIfNewUser").post(async (req, res) => {
    ...
    try {
        ...
        if(!currentuser.hasOwnProperty('sharedlist_id') && !currentuser.hasOwnProperty('score'))
        {
                let information1 = {};
                await axios
                .post("https://https://our-anime-list-beta.herokuapp.com//listings/getUserById", {username: currentuser.info.name})
                .then((response) => {
                    if (response.data === {}) {
                        res.status(400).send("No user found in MongoDB!");
                        return;
    ...
    try{
        ...
        await axios
            ...
            for(let i = 0; i < count5; i ++)
            {
                ...
                await axios
                    .post("https://https://our-anime-list-beta.herokuapp.com//listings/getGenre", item)
                    .then((response) => {
